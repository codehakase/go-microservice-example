...
func (*Vessel) Descriptor() ([]byte, []int) {
	return fileDescriptor_vessel_cf4033952639e125, []int{0}
}
...
func (*Specification) Descriptor() ([]byte, []int) {
	return fileDescriptor_vessel_cf4033952639e125, []int{1}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_vessel_cf4033952639e125, []int{2}
}
...
func init() { proto.RegisterFile("proto/vessel/vessel.proto", fileDescriptor_vessel_cf4033952639e125) }

var fileDescriptor_vessel_cf4033952639e125 = []byte{
